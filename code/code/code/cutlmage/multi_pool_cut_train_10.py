...
if __name__ == "__main__":
    ...
    parser.add_argument("-image_path",type=str,default=r"./SourceImageData/image_10.png")
    parser.add_argument("-label_path",type=str,default=r"./SourceImageData/image_10_label.png")
    parser.add_argument("-save_dir",type=str,default=r"./TrainDataFinal/")
