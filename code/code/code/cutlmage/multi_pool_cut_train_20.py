...
if __name__ == "__main__":
    ...
    parser.add_argument("-image_path",type=str,default=r"./SourceImageData/image_20.png")
    parser.add_argument("-label_path",type=str,default=r"./SourceImageData/image_20_label.png")
    parser.add_argument("-save_dir",type=str,default=r"./ValData/")
