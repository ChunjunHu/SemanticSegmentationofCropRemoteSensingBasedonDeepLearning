...
if __name__ == "__main__":
    ...
    parser.add_argument("-image_path",type=str,default=r"./SourceImageData/image_1.png")
    parser.add_argument("-label_path",type=str,default=r"./SourceImageData/image_1_label.png")
