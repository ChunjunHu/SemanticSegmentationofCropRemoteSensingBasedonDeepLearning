...
if __name__ == "__main__":
    ...
    parser.add_argument("-image_path",type=str,default=r"./SourceImageData/image_21.png")
    parser.add_argument("-label_path",type=str,default=r"./SourceImageData/image_21_label.png")
