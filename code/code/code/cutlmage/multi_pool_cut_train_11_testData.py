...
if __name__ == "__main__":
    path = r"./SourceImageData/image_11.png"
    image_resize_save_mask(path)
    # parser = ArgumentParser(description="")
    # parser.add_argument("-image_n",type=int)
    # parser.add_argument("-image_path",type=str,default=r"./SourceImageData/image_2.png")
    # parser.add_argument("-label_path",type=str,default=r"./SourceImageData/image_2_label.png")
    # parser.add_argument("-save_dir",type=str,default=r"./TrainData/")
